...
#define TAPPING_TOGGLE 2 // double tab to toggle layer
#define ONESHOT_TAP_TOGGLE 2 // double tap to toggle
...
[_BASE] = LAYOUT_kc(
// |-----+-----+-----+-----+-----+-----|     |-----+-----+-----+-----+-----+-----|
    RAISE,  Q  ,  W  ,  F  ,  P  ,  B  ,        J  ,  L  ,  U  ,  Y  ,     , BSPC,
// |-----+-----+-----+-----+-----+-----|     |-----+-----+-----+-----+-----+-----|
   ESCTRL,  A  ,  R  ,  S  ,  T  ,  G  ,        M  ,  N  ,  E  ,  I  ,  O  ,ENTER,
// |-----+-----+-----+-----+-----+-----|     |-----+-----+-----+-----+-----+-----|
     CAC , MSFT,  Z  ,  C  ,  D  ,  V  ,        K  ,  H  ,  X  , DOT , SLSH,     ,
// |-----+-----+-----+-----+-----+-----|     |-----+-----+-----+-----+-----+-----|
                   ,,,     ,  A  ,LOWER,       SPC ,  B  ,     ,,,
//                   |-----+-----+-----|     |-----+-----+-----|
),
...
[_LOWER] = LAYOUT_kc(
// |-----+-----+-----+-----+-----+-----|     |-----+-----+-----+-----+-----+-----|
         , DOT ,  1  ,  2  ,  3  , ASTR,       QUOT, MINS, EQL , BSLS, TILD, DEL ,
// |-----+-----+-----+-----+-----+-----|     |-----+-----+-----+-----+-----+-----|
