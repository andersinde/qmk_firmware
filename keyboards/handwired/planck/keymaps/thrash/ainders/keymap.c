 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |MShift| Shift|  Z   |   X  |   C  |   V  |   B  |   K  |   M  |   ,  |   .  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    OSM(MOD_LSFT), KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_ENT ,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS,    KC_PLUS,    KC_LPRN, KC_RPRN, KC_PIPE,
...
/* Adjust (Lower + Raise)
 * ,-----------------------------------------------------------------------------------.
 * |EEPROM| Reset|      |      |GUI_on|      |      |Qwerty|Colemk|      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |      |      |      | left | down | up   |right |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
...
[_ADJUST] = LAYOUT_planck_grid(
    EEPROM_RESET, RESET,DEBUG,  _______, MAGIC_UNNO_GUI	, _______, QWERTY, COLEMAK, _______, _______, _______, KC_DEL ,
